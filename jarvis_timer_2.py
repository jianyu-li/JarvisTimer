"""
Jarvis Timer 2 – memory-cached, no-flicker version 2025-05-01
"""
...
class JarvisTimer2(hass.Hass):
    # ──────────────────────────────────────────────────────
    def initialize(self):
        self.helper = "input_text.jarvis_timer_data_2"
        self.sensor = "sensor.jarvis_timer_2"
    ...
    def _parse_helper(self):
        ...
        try:
            ...
            if trigger_ms <= 0:
                self.log("Timer 2 JSON missing triggerTime", level="WARNING")
                self.timer = None
                return
            ...
            self.log(f"JarvisTimer2 parse error: {err}", level="WARNING")
            self.timer = None
    ...
    def _tick(self, *_):
        ...
        attrs = {
            "friendly_name": "Jarvis next Timer 2",
            "status": "ON",
            "total_active": 1,
            "total_all": 1,
